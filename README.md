...
<body>
  ...
  <div class="contenedor">
    ...
    <form action="https://formspree.io/f/mgegyqvn" method="POST" style="max-width: 500px; margin: 0 auto;">
  ...
  <textarea id="message" name="message" rows="5" required style="width: 100%; margin-bottom: 15px;"></textarea><br />
